...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    ...
    for i in range(num_gt):
        ...
        if ((gt_anno["num_points_in_gt"][i] <= MIN_NUM[difficulty])
            or (gt_anno["density_points_in_gt"][i] <= MIN_DENSITY[difficulty])
            or (gt_anno["distribution_points_in_gt"][i] <= MIN_DIRSTRIBUTION[difficulty])):
            ignore = True
